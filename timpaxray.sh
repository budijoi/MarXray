...
wget -q -O tesidom.sh https://raw.githubusercontent.com/budijoi/MarXray/refs/heads/main/tesidom.sh && chmod +x tesidom.sh && ./tesidom.sh
sleep 1
rm -r /etc/nginx/nginx.conf
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/budijoi/MarXray/refs/heads/main/nginx.conf"
...
wget -q -O /root/marzban/xray_config.json "https://raw.githubusercontent.com/budijoi/MarXray/refs/heads/main/xray_config.json"
docker compose up -d
clear 
